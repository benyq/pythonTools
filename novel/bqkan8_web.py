...
class BQKan8Fetcher(NovelFetcher):
    ...
    def __init__(self, novel_name, novel_url):
        ...
        self.chapter_reg = '//dt[text()="《{}》正文卷"]/following-sibling::dd/a'.format(self.novel_name)
        self.content_reg = '//div[@id="content"]/text()'
    ...
    def fetch_chapter(self):
        ...
        chapter_xpath_reg = '//dt[text()="《{}》正文卷"]/following-sibling::dd/a'.format(self.novel_name)
    ...
    async def async_fetch_content(self, index, novel):
        ...
        async with aiohttp.ClientSession() as session:
            async with session.get(self.base_url + novel.chapter_url, headers=self.novel_headers) as resp:
                result = await resp.text(encoding='gbk', errors='ignore')
...
if __name__ == '__main__':
    fetcher = BQKan8Fetcher("荣耀骑士团", "https://www.bqkan8.com/4_4024/")
